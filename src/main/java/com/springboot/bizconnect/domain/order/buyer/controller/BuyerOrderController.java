package com.springboot.bizconnect.domain.order.buyer.controller;
...
@Tag(name = "BuyerOrder", description = "구매사 주문 관련 API")
public class BuyerOrderController {
    ...
    @Operation(summary = "주문 취소", description = "내가 넣은 주문을 취소합니다.") // status => close 상대 회사에도 message 전송
