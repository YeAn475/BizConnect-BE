...
public interface AlarmService {
    ...
    // 요청 결과 리턴
    void sendToUser(User sender, Long receiverNo, String title, String content, AlarmType alarmType, Long referenceNo);
    // 운영관리자(회사 등록 요청, 시스템 문의, 신고 접수)
    void sendToOperationAdmins(User sender, String title, String content, AlarmType alarmType, Long referenceId);
    ...
    void sendToCompanyMembers(User sender, Long companyNo, String title, String content, AlarmType alarmType);
